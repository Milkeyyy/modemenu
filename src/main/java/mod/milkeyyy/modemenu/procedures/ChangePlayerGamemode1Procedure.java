...
public class ChangePlayerGamemode1Procedure extends ModemenuModElements.ModElement {
	public ChangePlayerGamemode1Procedure(ModemenuModElements instance) {
		super(instance, 8);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ModemenuMod.LOGGER.warn("Failed to load dependency entity for procedure ChangePlayerGamemode1!");
			return;
		}
		...
		if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
			((PlayerEntity) entity).sendStatusMessage(new StringTextComponent((("[\u00A79ModEMenu\u00A7r] ") + ""
					...
					+ "" + ("\u00A7bCreative\u00A7r") + "" + (((entity.getCapability(ModemenuModVariables.PLAYER_VARIABLES_CAPABILITY, null)
